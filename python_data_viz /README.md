...
이 프로젝트는 삼일회계법인 디지털 트랙 지원을 위해 데이터 분석 및 시각화 역량을 선보이고자 진행되었습니다. 국내 주요 기업인 KB금융지주와 SK이노베이션의 지난 3년간(2022-2024년) 지속가능경영보고서를 분석했습니다.

**이 두 기업을 선정한 이유는 삼일회계법인과의 잠재적 이해관계 및 상반된 산업 특성을 고려했기 때문입니다.**
...
[**코드 보러가기**](./coding/esg_analysis.py)
