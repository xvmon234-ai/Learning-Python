...
이 프로젝트는 삼일회계법인 디지털 트랙 지원을 위해 데이터 분석 및 시각화 역량을 선보이고자 진행되었습니다. 국내 주요 기업인 KB금융지주(금융업)와 SK이노베이션(제조/에너지업)의 지난 3년간(2022-2024년) 지속가능경영보고서를 분석했습니다.
...
이 섹션에서는 ESG 키워드 빈도와 온실가스 배출량 분석을 기반으로 시각화된 트렌드와 도출된 인사이트를 제시합니다.
...
* **KB금융지주 (금융)**:
    * **트렌드**: E-키워드 빈도: 2022 (507) → 2023 (567) → 2024 (421).
...
* **KB금융지주 (금융)**:
    * **트렌드**: S-키워드 빈도: 2022 (228) → 2023 (272) → 2024 (349).
...
* **KB금융지주 (금융)**:
    * **트렌드**: G-키워드 빈도: 2022 (361) → 2023 (711) → 2024 (586).
...
* **KB금융지주 (금융)**:
    * **트렌드**: GHG 배출량: 2022 (11,143,025 tCO2eq) → 2023 (11,654,901 tCO2eq) → 2024 (12,056,770 tCO2eq).
