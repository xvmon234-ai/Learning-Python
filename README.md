# 변화하는 감사 환경 대비 Digital 학습 기록

-----
## 🚀 프로젝트/학습 개요

이 GitHub 저장소는 **변화하는 감사환경에 대한 Digital역량 향상**을 목표로 한 **Python 학습 여정**을 기록합니다. **AI(Gemini)와 협업**하여 Python 기본기, Pandas 데이터 처리/시각화, 웹 스크래핑 등을 **초고속으로 습득**한 내용을 담고 있습니다.

특히, [**"ESG 공시 트렌드 분석: KB금융지주 & SK이노베이션" 프로젝트**](https://github.com/xvmon234-ai/Learning-Python/blob/main/python_data_viz%20/README.md)는 본 학습 역량을 실제 데이터 분석에 적용한 결과물입니다. **회계법인과의 잠재적 이해관계** 및 \*\*상반된 산업 특성(금융 vs. 제조/에너지)\*\*을 고려해 두 기업을 선정했습니다. 이 프로젝트는 ESG 키워드 언급 빈도와 온실가스 배출량 트렌드를 분석 및 시각화하여, 데이터 기반의 비즈니스 인사이트 도출 역량을 선보이고자 했습니다.

본 저장소의 학습 기록은 변화하는 디지털 환경에서 공인회계사가 추구해야하는 **AI 활용 능력, 문제 해결 역량, 그리고 빠른 학습 속도**를 증명하는 자료가 될 것입니다.

---

## 💡 Python 학습 동기 및 AI 활용 전략

이 프로젝트는 단순히 기술 역량을 보여주는 것을 넘어, **Python 학습을 시작한 배경**과 **AI(Gemini)를 활용한 학습 및 업무 효율화 전략**을 담고 있습니다.
...
Python 학습 및 프로젝트 수행 과정에서 다음과 같은 **이유**로 Google의 **Gemini**를 주요 파트너로 활용했습니다.
...
* **회계법인의 업무 철학과의 연계**: AI를 통한 업무 효율화 및 디지털 전환에 대한 이러한 접근 방식은 여러 회계법인이 추구하는 **'스마트워크'** 및 **'디지털 혁신'** 철학과 일맥상통한다고 생각합니다. 변화하는 환경에 맞춰 신기술을 적극 활용하여 업무의 질과 효율을 높이는 것은 디지털 감사환경에서의 핵심 가치라고 믿습니다.

### 짧은 기간 내 성과 및 향후 기여

Python 학습을 시작한 지 **2주도 채 되지 않은 시점**에 Gemini와의 협업을 통해 본 프로젝트 결과물을 완성했습니다. 이는 제가 **새로운 기술을 빠르게 습득하고 실제 문제 해결에 적용하는 능력**을 보유하고 있음을 보여줍니다. 향후 회계법인에서도 급변하는 디지털 환경 속 새로운 기술 습득이 필요할 때, 저의 이러한 경험과 AI 활용 능력이 **조직의 디지털 전환과 고품질 서비스 제공에 기여**할 수 있을 것으로 기대합니다.

-----

## 💡 학습 커리큘럼 소개

다음의 커리큘럼은 **AI(Gemini)를 활용**하여 변화하는 디지털 감사환경에 최적화된 역량을 기르기 위해 설계된 초고속 학습 로드맵입니다. AI의 도움으로 얻은 면접 진행 방식과 예상 질문에 맞춰 파이썬 기본기, 데이터 분석 역량, 그리고 데이터 수집 능력을 강화하는 데 초점을 맞추었습니다.
