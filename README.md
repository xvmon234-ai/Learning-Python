...
특히, [**"ESG 공시 트렌드 분석: KB금융지주 & SK이노베이션" 프로젝트**](https://github.com/xvmon234-ai/Learning-Python/blob/main/python_data_viz%20/README.md)는 본 학습 역량을 실제 데이터 분석에 적용한 결과물입니다. **삼일회계법인과의 잠재적 이해관계** 및 \*\*상반된 산업 특성(금융 vs. 제조/에너지)\*\*을 고려해 두 기업을 선정했습니다. 이 프로젝트는 ESG 키워드 언급 빈도와 온실가스 배출량 트렌드를 분석 및 시각화하여, 데이터 기반의 비즈니스 인사이트 도출 역량을 선보이고자 했습니다.
